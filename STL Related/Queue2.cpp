...
int main()
{
	T{
		...
		queue<int>Q;
		cout << "Plz enter the elements of queue : ";
		for(i=0; i<N; i++)
		{
			cin >> t;
			Q.push(t);
		...
		cout << "Queue Front Value is : " << Q.front() << endl;
		cout << "Queue Back Value is : " << Q.back() << endl;
		Q.pop();
		cout << "After One element remove then queue is : ";
		showqueue(Q);
		cout << endl;
