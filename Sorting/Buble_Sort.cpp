...
//Create a New Funcion_____________________
void Babule_Sort(int A[],int N)
{
	  int i,j,temp;
...
//Main Function_____________________
int main()
{
    ...
    T{
          ...
          cout << "Before Babule Sorting Array : ";
          for(i = 0; i < N; i++)cout << A[i] << " ";

		      Babule_Sort(A,N);
		      cout << endl << "After Babule Sorting Array : ";
